...
const About = () => {
  ...
  return (
    <>
      <Head>
        <title>Victor Ezekiel | About Page</title>
      ...
      <main className="flex w-full flex-col items-center justify-between dark:text-light ">
        <Layout className="pt-12">
          <AnimatedText
            text="Determination Drives Destiny!"
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            ...
            >
              ...
              <Image
                src={profilePic}
                alt="Victor"
                className="w-full h-[25rem] object-cover object-top rounded-2xl"
                priority
